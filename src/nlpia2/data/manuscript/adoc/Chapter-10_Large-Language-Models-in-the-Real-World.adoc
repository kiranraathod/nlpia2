...
This gives a fair estimate of both the dataset size and complexity of the LLM.
If you plot model accuracy against this measure of the size of the LLM you find that there's nothing all that surprising or emergent in the results.
