...
These six word-topic vectors are shown in <<six-lovable-words>>, one for each word, represent the meanings of your six words as 3D vectors.

[#six-lovable-words]
.Six lovable words in 3D
