...
* Transfering the learning of popular transformers like BERT and GPT (GPT-2)
* Choosing and using a LLM (Large Language Model) with prompt engineering
...
Transformers are changing the world.
They've created and destroyed whole new job categories.
The concept of prompt engineering came into being as tech companies raced to find engineers to design ChatGPT prompts that could give them a competitive edge.
Influentual CyberSecurity experts are bragging about spending augmenting their thinking with the help of 40-100 ChatGPT interactions per day.footnote:[For two months after ChatGPT's release, Dan Miessler spent almost half of his "Unsupervised Learning" podcasts discussing ChatGPT, Bard, and Bing (https://danielmiessler.com/)]
research make money off of ChatGPT.
Microsoft News and the MSN.com website layed off its journalists in 2020, replacing them with transformer models capable curating and summarizing news article automatically.

You're about to learn how transformers work and how you can put them to work.
It's not enough just to be able to write a good prompt.
Almost anyone can learn how to do that.
The real opportunity is for people who can fine-tune large language models like Chat GPT for their own applications.
...
And Vishvesh Bhat did this for college math students with his clevrly.io transformer language models.footnote:[Some of vish's fine-tuned transformers is available on Huggingface (https://huggingface.co/clevrly)]
...
Transformers now make it possible for us to make good on our promise to generate worthy content that can be incorporated into a book like this without you noticing the difference.
