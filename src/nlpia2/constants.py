...
HOBS_MANUSCRIPT_DIR = BASE_DIR
HOBS_RELATIVE_MANUSCRIPT_DIR = Path('hobs') / 'nlpia-manuscript' / 'manuscript'
for i in range(4):
    HOBS_MANUSCRIPT_DIR = HOBS_MANUSCRIPT_DIR.parent
    if (HOBS_MANUSCRIPT_DIR / HOBS_RELATIVE_MANUSCRIPT_DIR).is_dir():
        break
HOBS_MANUSCRIPT_DIR = HOBS_MANUSCRIPT_DIR / HOBS_RELATIVE_MANUSCRIPT_DIR
HOBS_ADOC_DIR = HOBS_MANUSCRIPT_DIR / 'adoc'
