...
if __name__ == '__main__':
    ...
    nbs = adocs2notebooks(adoc_dir=adoc_dir, dest_dir=dest_dir, glob='CH*.adoc')
    print(nbs)
    # nbs = adocs2notebooks(adoc_dir, dest_dir=BASE_DIR / 'src' / 'nlpia2' / 'notebooks', glob='CH*.adoc')
    print(nbs)
